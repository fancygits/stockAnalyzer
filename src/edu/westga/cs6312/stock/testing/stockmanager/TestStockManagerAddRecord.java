...
class TestStockManagerAddRecord {
	...
	void testAddRecordAndToStringShouldReturnStockRecordToString() {
		...
		appleStock.addRecord(new StockRecord("3/16/2018", 178.649994, 179.119995, 177.619995, 178.020004, 178.020004, 39404700));
	...
	void testAddRecordFor5StockRecodsShouldReturnFormattedToString() {
		...
		appleStocks.addRecord(new StockRecord("3/16/2018", 178.649994, 179.119995, 177.619995, 178.020004, 178.020004, 39404700));
		appleStocks.addRecord(new StockRecord("3/19/2018", 177.320007, 177.470001, 173.660004, 175.300003, 175.300003, 33446800));
		appleStocks.addRecord(new StockRecord("3/20/2018", 175.240005, 176.800003, 174.940002, 175.240005, 175.240005, 19649400));
		appleStocks.addRecord(new StockRecord("3/21/2018", 175.039993, 175.089996, 171.259995, 171.270004, 171.270004, 37054900));
		appleStocks.addRecord(new StockRecord("3/22/2018", 170, 172.679993, 168.600006, 168.850006, 168.850006, 41490800));
		assertEquals("2018-03-16     178.65     179.12     177.62     178.02     178.02  39404700\n"
