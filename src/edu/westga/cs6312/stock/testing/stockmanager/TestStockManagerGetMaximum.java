...
/**
 * Tests the getMaximum method of StockManager
 * @author James Luke Johnson
 * @version 2018.04.25
 */
class TestStockManagerGetMaximum {

	/**
	 * Test to confirm that getMaximum on empty StockManager returns 0
	 * Test method for {@link edu.westga.cs6312.stock.model.StockManager#getMaximum()}.
	 */
	@Test
	void testGetMaximumForEmptyStockManagerShouldReturn0() {
		StockManager empty = new StockManager();
		assertEquals(0, empty.getMaximum());
	}
	
	/**
	 * Test to confirm that a StockManager with 5 StockRecords should
	 * return getMaximum as 178.020004
	 */
	@Test
	void testGetMaximumForStockManagerWith5StockRecordsShouldReturn178() {
		...
		assertEquals(178.020004, appleStocks.getMaximum());
	}
